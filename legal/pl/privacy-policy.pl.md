...
## 2. Zbieranie informacji i lokalne przechowywanie
NearbyWeather nie wymaga konta użytkownika. Aplikacja nie sprzedaje danych osobowych, nie wykorzystuje identyfikatorów reklamowych i nie tworzy profili reklamowych ani śledzących.

Aplikacja może przechowywać lokalnie na Twoim urządzeniu następujące informacje:

- dodane do zakładek stacje pogodowe i ostatnio usunięte zakładki
- wybrane w pobliżu, wyszukiwanie, jednostka, powiadomienia, język, wygląd i preferencje dostawcy pogody
- buforowane metadane stacji pogodowej, dane pogodowe, stan mapy i metadane kamery internetowej potrzebne do wyświetlania zawartości aplikacji i obsługi trybu offline
- opcjonalna preferencja raportowania awarii Firebase

Dane te pozostaną na Twoim urządzeniu, chyba że funkcja opisana poniżej wyśle niezbędne dane żądania do usługi NearbyWeather lub zewnętrznego dostawcy.

## 3. Informacje o lokalizacji i dane pogodowe
Jeśli zezwolisz na lokalizację, NearbyWeather użyje lokalizacji Twojego urządzenia („Informacje o lokalizacji”), aby znaleźć pobliskie stacje pogodowe, skupić mapy i zażądać danych pogodowych dla odpowiednich współrzędnych. W zależności od wybranych funkcji i ustawień aplikacji, aplikacja może wysyłać informacje o lokalizacji, identyfikatory stacji pogodowych, wybór dostawców, preferencje językowe i szczegóły żądań pogodowych do usług NearbyWeather lub zewnętrznych dostawców i podmiotów przetwarzających dane.
...
- informacje techniczne dotyczące awarii lub zdarzenia diagnostycznego
