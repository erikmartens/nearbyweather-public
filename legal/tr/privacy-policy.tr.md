...
## 2. Bilgi Toplama ve Yerel Depolama
...
## 3. Konum Bilgisi ve Hava Durumu Verileri
Konum izni verirseniz NearbyWeather, yakındaki hava istasyonlarını bulmak, haritalara odaklanmak ve ilgili koordinatlar için hava durumu verilerini istemek için cihazınızın konumunu ("Konum Bilgileri") kullanır. Seçilen özellik ve uygulama ayarlarına bağlı olarak Uygulama, Konum Bilgilerini, hava durumu istasyonu tanımlayıcılarını, sağlayıcı seçimlerini, dil tercihlerini ve hava durumu isteği ayrıntılarını NearbyWeather hizmetlerine veya üçüncü taraf veri sağlayıcılarına ve işlemcilerine gönderebilir.
