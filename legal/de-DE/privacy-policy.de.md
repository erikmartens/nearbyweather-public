...
## 4. App-Integrität und datenschutzwahrende Dienstanalyse
Um zu prüfen, dass geschützte Anfragen von echten NearbyWeather-App-Installationen stammen, Replay-Angriffe und Missbrauch zu verhindern und Kontingente externer Datenanbieter zu schützen, können NearbyWeather-Dienste eine appspezifische App-Attest-Berechtigung, Assertion-Zähler, kurzlebige Challenges und den Kontingentstatus je Installation verarbeiten. Diese Sicherheitswerte sind keine Werbekennungen. Sie werden weder zum Anlegen eines Benutzerkontos noch für einen Verlauf der angefragten Wetterorte oder Anbieter verwendet. Aktive Berechtigungen und Zähler werden so lange aufbewahrt, wie sie für Prüfung und Widerruf erforderlich sind; abgelaufene Challenges, inaktiver Kontingentstatus und widerrufene Berechtigungen werden nach begrenzten Wartungsfristen gelöscht.

Zur Absicherung, zum Betrieb und zur Planung des Dienstes kann NearbyWeather außerdem schätzen, wie viele unterschiedliche App-Installationen erfolgreich zugelassene Anfragen senden, und die Gesamtzahl der Anfragen in festen Berichtszeiträumen zählen. Die Integritätsberechtigung dient nur als vorübergehende Eingabe und wird sofort in einen zeitraumspezifischen, nicht rückführbaren Beitrag zu einer ungefähren Gesamtschätzung umgewandelt. NearbyWeather speichert im Analysedatensatz weder die Berechtigung noch eine dauerhafte Analysekennung, eine exakte Installationsliste oder eine Verknüpfung zwischen Berichtszeiträumen. Gespeichert werden nur ungefähre aggregierte Skizzen, Anfragezahlen, Zeitraumsgrenzen und Aktualitätszeitstempel. Die maximale Aufbewahrung beträgt 48 Stunden für 15-Minuten-Aggregate, 90 Tage für Tages-, 56 Wochen für Wochen- und 13 Monate für Monatsaggregate. Interne Ergebnisse unter 10 unterschiedlichen Installationen werden unterdrückt.

Diese Verarbeitung dient Dienstsicherheit, Kapazitätsplanung, Zuverlässigkeit und aggregierten Produktentscheidungen. Soweit anwendbar, sind die berechtigten Interessen von NearbyWeather am sicheren, zuverlässigen und effizienten Betrieb die Rechtsgrundlage; ihnen stehen Datenminimierung, Zeitraumtrennung, beschränkter Zugriff und begrenzte Aufbewahrung gegenüber. Die Daten werden nicht für Werbung, eine für Betreiber sichtbare Clientliste oder den Versand von Mitteilungen verwendet. Ein späteres serverseitiges Benachrichtigungssystem erhält eine eigene Offenlegung sowie eigene Einwilligungs- und Lebenszyklusregeln. Der Verarbeitung auf Grundlage berechtigter Interessen können Sie über den Kontakt in Abschnitt 17 widersprechen.

## 5. Absturz- und Fehlerberichte (optional)
...
## 6. Supportbezogene Kommunikation
...
## 7. Benachrichtigungen, Hintergrundaktualisierung und Kennzeichen am App-Symbol
...
## 8. Webcams und Links von Drittanbietern
...
## 12. Datenanbieter und Auftragsverarbeiter Dritter
...
## 13. Rechtliche Anforderungen und Schutz des Dienstes
