...
## 1. Aperçu
Les présentes conditions d'utilisation régissent votre utilisation de NearbyWeather (« l'application »). L'application fournit une interface mobile pour les informations météorologiques et les fonctionnalités météorologiques associées.

## 2. Confidentialité
Votre utilisation de l'application est également soumise à la politique de confidentialité de NearbyWeather, qui décrit la manière dont l'application traite les informations.

## 3. Données météorologiques et fournisseurs de données tiers
Les informations météorologiques, les prévisions, les données sur la qualité de l'air, les données d'altitude, les métadonnées de station, les métadonnées de webcam et les liens externes peuvent provenir des services NearbyWeather ou de fournisseurs tiers tels que Apple Weather / WeatherKit, OpenWeather, Open-Meteo et des fournisseurs de webcam.

NearbyWeather peut utiliser des services qui demandent, mettent en cache et renvoient des données météorologiques pour l'application. NearbyWeather n'est pas affilié, approuvé par ou responsable des fournisseurs de données tiers, sauf indication expresse. La disponibilité, l'exactitude, les conditions de licence et le comportement du service des données tierces échappent au contrôle de l'application. Les fournisseurs tiers peuvent changer, devenir indisponibles ou être remplacés, et l'application ne garantit pas qu'un fournisseur spécifique restera disponible.
...
## 5. Emplacement, notifications et fonctionnement en arrière-plan
...
L'application, sa conception, son code et son contenu non tiers appartiennent au développeur ou aux concédants de licence concernés. Les données tierces, les marques déposées, les noms de fournisseurs, le contenu cartographique et le contenu externe restent la propriété de leurs propriétaires respectifs. Ces Conditions ne vous accordent pas de droits au-delà de l'utilisation personnelle de l'Application.

## 8. Aucune garantie
L'Application est fournie « telle quelle » et « telle que disponible » sans garantie d'aucune sorte. Nous ne garantissons pas :

- disponibilité ininterrompue
- fonctionnement sans erreur
- compatibilité avec chaque appareil, version de iOS, fournisseur ou condition du réseau
...
## 10. Modifications apportées à l'application et aux fournisseurs
Les fonctionnalités de NearbyWeather, les intégrations de fournisseurs, les sources de données et le comportement du service peuvent changer au fil du temps. Les fonctionnalités peuvent être ajoutées, modifiées, suspendues ou interrompues sans garantir la disponibilité continue d'un fournisseur, d'une source de données ou d'une fonctionnalité spécifique.
