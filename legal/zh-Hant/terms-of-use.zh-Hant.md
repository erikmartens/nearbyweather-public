...
## 1. 概述
NearbyWeather（「應用程式」）提供天氣資訊和相關天氣功能的移動介面。
...
NearbyWeather 可能會使用為應用程式請求、快取和傳回天氣資料的服務。除非明確說明，NearbyWeather 不隸屬於第三方供應商，也不由第三方提供者認可，也不對第三方提供者負責。第三方資料的可用性、準確性、許可條款和服務行為不在應用程式的控制範圍內。
...
## 5. 外部連結與網路攝影機
該應用程式可能會開啟網站、支援頁面、供應商歸屬頁面、網路攝影機頁面、GitHub 問題頁面或電子郵件用戶端。 NearbyWeather 對外部服務的內容、可用性、隱私權做法或條款不承擔任何責任。

## 6. 無保修
該應用程式是「按原樣」提供，不提供任何形式的保證。我們不保證：
