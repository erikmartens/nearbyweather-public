...
- weerstations met bladwijzers en onlangs verwijderde bladwijzers
- geselecteerde voorkeuren voor dichtbij, zoeken, eenheid, melding, taal, uiterlijk en weerprovider
- Metagegevens van weerstations in de cache, weersgegevens, kaartstatus en webcam-metagegevens die nodig zijn om app-inhoud weer te geven en offline gebruik te ondersteunen
- de optionele Firebase crashrapportagevoorkeur
...
## 4. App-integriteit en privacybeschermende serviceanalyse
Om te controleren dat beschermde verzoeken afkomstig zijn van echte NearbyWeather-installaties, herhaling en misbruik te voorkomen en quota van externe providers te beschermen, kunnen NearbyWeather-services een appspecifieke App Attest-referentie, assertiontellers, kortdurende uitdagingen en quotastatus per installatie verwerken. Deze beveiligingswaarden zijn geen advertentie-identificatoren en worden niet gebruikt om een account of geschiedenis van aangevraagde weerlocaties of providers te maken. Actieve referenties en tellers worden bewaard zolang ze nodig zijn voor verificatie en intrekking; verlopen uitdagingen, inactieve quotastatus en ingetrokken referenties worden volgens beperkte onderhoudsschema's verwijderd.

Om de service te beveiligen, uit te voeren en te plannen kan NearbyWeather ook schatten hoeveel verschillende appinstallaties succesvol toegelaten verzoeken doen en het totale aantal verzoeken in vaste perioden tellen. De integriteitsreferentie wordt alleen tijdelijk gebruikt en direct omgezet in een eenrichtingsbijdrage per periode aan een geschatte aggregatie. NearbyWeather bewaart in de analysedataset niet de referentie, een blijvende analyse-identificator, een exacte installatielijst of een koppeling tussen perioden. Alleen geschatte geaggregeerde schetsen, aantallen verzoeken, periodegrenzen en tijdstempels voor actualiteit worden opgeslagen. Maximale bewaring is 48 uur voor aggregaten van 15 minuten, 90 dagen voor dagelijkse, 56 weken voor wekelijkse en 13 maanden voor maandelijkse. Interne resultaten onder 10 verschillende installaties worden onderdrukt.

Deze verwerking ondersteunt servicebeveiliging, capaciteitsplanning, betrouwbaarheid en geaggregeerde productbeslissingen. Waar van toepassing is de rechtsgrond het gerechtvaardigde belang van NearbyWeather bij een veilige, betrouwbare en efficiënte service, afgewogen met gegevensminimalisatie, periodescheiding, beperkte toegang en bewaring. Ze wordt niet gebruikt voor advertenties, maakt geen voor operators zichtbare klantenlijst en wordt niet gebruikt om meldingen te sturen. Een toekomstig servermeldingssysteem krijgt een afzonderlijke toelichting en eigen toestemmings- en levenscyclusregels. U kunt via het contact in sectie 17 bezwaar maken tegen verwerking op grond van gerechtvaardigd belang.

## 5. Crash- en foutrapportage (optioneel)
...
Crash- en diagnostische rapporten kunnen het volgende omvatten:

- apparaattype en versie van het besturingssysteem
- app-versie en buildnummer
- technische informatie over de crash of diagnostische gebeurtenis
...
## 6. Ondersteuningsgerelateerde communicatie
...
## 7. Meldingen, achtergrondvernieuwing en app-pictogrambadge
...
## 11. Bewaren en verwijderen van gegevens
...
## 12. Externe gegevensproviders en verwerkers
...
## 13. Wettelijke vereisten en servicebescherming
