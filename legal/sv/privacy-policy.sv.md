...
## 4. Appintegritet och integritetsbevarande tjänsteanalys
För att kontrollera att skyddade begäranden kommer från äkta NearbyWeather-installationer, förhindra återuppspelning och missbruk samt skydda tredjepartsleverantörers kvoter kan NearbyWeather-tjänster behandla en appspecifik App Attest-behörighet, assertionsräknare, kortlivade utmaningar och kvotstatus per installation. Dessa säkerhetsvärden är inte reklamidentifierare och används inte för att skapa ett användarkonto eller en historik över begärda väderplatser eller leverantörer. Aktiva behörigheter och räknare behålls medan de behövs för verifiering och återkallelse; utgångna utmaningar, inaktiv kvotstatus och återkallade behörigheter raderas enligt begränsade underhållsscheman.

För att säkra, driva och planera tjänsten kan NearbyWeather också uppskatta hur många olika appinstallationer som gör godkända begäranden och räkna det totala antalet begäranden under fasta perioder. Integritetsbehörigheten används bara tillfälligt och omvandlas omedelbart till ett enkelriktat, periodspecifikt bidrag till en ungefärlig sammanställning. NearbyWeather lagrar inte behörigheten i analysdata, en stabil analysidentifierare, en exakt installationslista eller en koppling mellan perioder. Endast ungefärliga aggregerade skisser, begärandeantal, periodgränser och aktualitetstidsstämplar lagras. Maximal lagring är 48 timmar för 15-minutersaggregat, 90 dagar för dagliga, 56 veckor för veckovisa och 13 månader för månatliga. Interna resultat under 10 olika installationer undertrycks.

Behandlingen stöder tjänstesäkerhet, kapacitetsplanering, tillförlitlighet och aggregerade produktbeslut. Där det är tillämpligt är den rättsliga grunden NearbyWeathers berättigade intressen av att driva en säker, tillförlitlig och effektiv tjänst, balanserade genom dataminimering, periodseparation, begränsad åtkomst och lagring. Den används inte för reklam, skapar ingen operatörssynlig klientlista och används inte för att skicka notiser. Ett framtida serverbaserat notissystem får separat information samt egna samtyckes- och livscykelregler. Du kan invända mot behandling baserad på berättigade intressen via kontakten i avsnitt 17.

## 5. Krasch- och felrapportering (valfritt)
...
Krasch- och diagnostiska rapporter kan innehålla:

- enhetstyp och operativsystemversion
- appversion och byggnummer
- teknisk information om kraschen eller diagnostisk händelse
...
## 6. Supportrelaterad kommunikation
...
## 7. Aviseringar, bakgrundsuppdatering och appikonmärke
...
## 8. Webbkameror och länkar från tredje part
...
## 12. Tredjepartsdataleverantörer och processorer
...
## 13. Juridiska krav och tjänsteskydd
