...
## 1. 概述
这些使用条款管辖您对 NearbyWeather（“应用程序”）的使用。该应用程序提供天气信息和相关天气功能的移动界面。

## 2. 隐私
您对应用程序的使用还须遵守 NearbyWeather 隐私政策，该政策描述了应用程序如何处理信息。

## 3. 天气数据和第三方数据提供商
天气信息、预报、空气质量数据、海拔数据、气象站元数据、网络摄像头元数据和外部链接可能来自 NearbyWeather 服务或第三方提供商，例如 Apple Weather / WeatherKit、OpenWeather、Open-Meteo 和网络摄像头提供商。

NearbyWeather 可能会使用为应用程序请求、缓存和返回天气数据的服务。除非明确说明，NearbyWeather 不隶属于第三方数据提供商，也不由第三方数据提供商认可，也不对其负责。第三方数据的可用性、准确性、许可条款和服务行为不在应用程序的控制范围内。第三方提供商可能会发生变化、变得不可用或被替换，并且应用程序不保证任何特定提供商将保持可用。
...
## 6. 外部链接和网络摄像头
该应用程序可能会打开网站、支持页面、提供商归属页面、网络摄像头页面、GitHub 问题页面或电子邮件客户端。 NearbyWeather 不对外部服务的内容、可用性、隐私惯例或条款负责。

## 7. 知识产权
该应用程序、其设计、代码和非第三方内容均归开发者或相关许可方所有。第三方数据、商标、提供商名称、地图内容和外部内容仍然是其各自所有者的财产。这些条款不授予您超出个人使用该应用程序的权利。

## 8. 无保证
该应用程序按“原样”和“可用”提供，不提供任何形式的保证。我们不保证：

- 不间断的可用性
- 无错误操作
- 与每个设备、iOS 版本、提供商或网络条件的兼容性
...
## 10. 应用程序和提供商的更改
NearbyWeather 功能、提供商集成、数据源和服务行为可能会随着时间而改变。可能会添加、修改、暂停或终止功能，但不保证任何特定提供商、数据源或功能的持续可用性。
