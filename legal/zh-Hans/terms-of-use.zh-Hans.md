...
## 1. 概述
NearbyWeather（“应用程序”）提供天气信息和相关天气功能的移动界面。
...
NearbyWeather 可能会使用为应用程序请求、缓存和返回天气数据的服务。除非明确说明，NearbyWeather 不隶属于第三方提供商，也不由第三方提供商认可，也不对第三方提供商负责。第三方数据的可用性、准确性、许可条款和服务行为不在应用程序的控制范围内。
